    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6">
        {filteredProducts.map((product) => (
          ...
          >
            {/* Product Image */}
            <div className="h-40 sm:h-48 bg-gray-50 flex items-center justify-center text-5xl sm:text-6xl relative border-b border-gray-200">
              {product.image}
            </div>
            ...
            <div className="p-3 sm:p-4">
              ...
              <div className="flex gap-1.5 sm:gap-2">
                <button className="flex-1 flex items-center justify-center gap-1 px-2 sm:px-3 py-2 bg-indigo-50 text-indigo-600 rounded-lg hover:bg-indigo-100 transition-colors text-xs sm:text-sm font-medium">
                  <Edit className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
                  <span className="hidden xs:inline">Edit</span>
                </button>
                <button className="flex items-center justify-center px-2 sm:px-3 py-2 bg-gray-50 text-gray-600 rounded-lg hover:bg-gray-100 transition-colors">
                  <Eye className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
                </button>
                <button
                  onClick={() => setShowDeleteConfirm(product.id)}
                  className="flex items-center justify-center px-2 sm:px-3 py-2 bg-red-50 text-red-600 rounded-lg hover:bg-red-100 transition-colors"
                >
