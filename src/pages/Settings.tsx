          ...
          <div className="bg-white rounded-2xl shadow-sm border border-blue-100 p-6 md:p-8">
            ...
            {activeTab === 'notifications' && (
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  {[
                    { title: 'Email Notifications', desc: 'Receive email about your account activity' },
                    { title: 'Order Updates', desc: 'Get notified when orders are placed or updated' },
                    { title: 'Product Alerts', desc: 'Alerts for low stock and out of stock products' },
                    { title: 'Marketing Emails', desc: 'Receive emails about new features and updates' },
                  ].map((item, index) => (
                    <div key={index} className="flex items-center justify-between p-4 border border-gray-200 rounded-xl hover:bg-blue-50 transition-colors">
                      <div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    {['Light', 'Dark', 'Auto'].map((theme) => (
                      ...
                      >
                        <div className="font-semibold text-gray-900 mb-1">{theme}</div>
                        <div className="text-sm text-gray-600">Use {theme.toLowerCase()} theme</div>
                      </button>
                    ))}
                  </div>
                </div>
