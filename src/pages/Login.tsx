    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="mt-6 p-4 bg-indigo-50 border border-indigo-200 rounded-lg">
          <p className="text-sm text-indigo-900 font-medium mb-1">Demo Credentials:</p>
          <p className="text-xs text-indigo-700">Email: admin@example.com</p>
          <p className="text-xs text-indigo-700">Password: any password</p>
        </div>
      </div>
    </div>
  );
